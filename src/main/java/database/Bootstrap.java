...
public class Bootstrap {
    ...
    public static void main(String[] args) throws SQLException {
        // dropAll(); //daca avem deja date comentam
    ...
    //se vor popula fiecare dintre tabele
    ...
    //legatura dintre tabela de roluri si tabela de drepturi
    ...
    //pentru eventuali  useri/admin/employee predefiniti pentru test
