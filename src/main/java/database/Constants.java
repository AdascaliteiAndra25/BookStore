...
public class Constants {
    ...
    public static class Tables {
        ...
        public static final String SOLD_BOOKS = "sold_books";

        public static final String[] ORDERED_TABLES_FOR_CREATION = new String[]{USER, ROLE, RIGHT, ROLE_RIGHT, USER_ROLE, SOLD_BOOKS};
